...
export default async function ReviewPage() {
  ...
  const workComplete = Boolean(draft.is_uk_based && (draft.offers_online || draft.offers_in_person) && (!draft.offers_in_person || (draft.business_postcode?.trim() && draft.in_person_mode)));
