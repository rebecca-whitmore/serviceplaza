...
export default async function ReviewPage() {
  ...
  const workComplete = Boolean(draft.is_uk_based && draft.base_town_city?.trim() && draft.uk_region?.trim() && (draft.offers_online || draft.offers_in_person) && (draft.serves_local || draft.serves_uk_wide));
