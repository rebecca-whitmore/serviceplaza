...
export function SubmitPanel({ versionId, ready }: { versionId: string; ready: boolean }) {
  ...
  return <section className={styles.submitCard}>
    ...
    <p className={styles.submissionNote}>Upon submission your application will be reviewed by our team and we&apos;ll email you with any updates. You&apos;ll also receive The Service Plaza Briefing, our newsletter with useful ideas, opportunities, and things worth knowing about running and marketing your independent business.</p>
