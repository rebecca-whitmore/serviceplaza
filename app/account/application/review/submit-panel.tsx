...
export function SubmitPanel({ versionId, ready }: { versionId: string; ready: boolean }) {
  ...
  return <section className={styles.submitCard}>
    ...
    <label className={styles.declaration}><input type="checkbox" checked={accepted} onChange={(event) => setAccepted(event.target.checked)} /><span><strong>I confirm that the information provided is accurate.</strong><small>I understand Service Plaza will review this application before publication and that acceptance does not represent an endorsement of the business or its services.<br />You will receive an email when your application has been updated. You will also receive The Service Plaza Briefing, our newsletter with useful ideas, opportunities, and things worth knowing about running, marketing, and getting your independent business found.</small></span></label>
    <div className={styles.communicationNotice}><strong>The Service Plaza Briefing is part of your listing.</strong><p>By submitting your application, you will receive our weekly email with useful ideas, opportunities and things worth knowing about running, marketing and getting your independent business found, plus what is happening at Service Plaza.</p><small>We may also send essential emails about your application, account, listing, security and any service request you ask us to handle.</small></div>
