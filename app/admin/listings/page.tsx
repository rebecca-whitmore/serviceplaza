...
export default async function AdminListingsPage() {
  ...
  const rows = (listings ?? []).map((listing) => {
    ...
    return { ...listing, version: versions?.find((version) => version.id === listing.current_published_version_id), business: businesses?.find((business) => business.id === listing.business_id), update };
  });
