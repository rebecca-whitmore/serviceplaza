...
export default async function AdminPage() {
  ...
  const { count: publishedCount } = await supabase.from("listings").select("id", { count: "exact", head: true }).eq("publication_status", "published");
