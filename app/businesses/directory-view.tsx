...
export async function DirectoryView({ query, categorySlug }: { query: Query; categorySlug?: string }) {
  ...
  return <div className={styles.page}>
    <header className={styles.siteHeader}><Link className={styles.brand} href="/"><span>SP</span><strong>Service Plaza</strong></Link><nav><Link className={styles.active} href="/businesses">Find a business</Link><Link href="/login">List your business</Link></nav></header>
