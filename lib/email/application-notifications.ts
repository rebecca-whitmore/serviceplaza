...
const content: Record<ApplicationNotificationType, { subject: string; intro: string; action: string }> = {
  ...
  approved: { subject: "Your Service Plaza application has been approved", intro: "Your business listing application has been approved. Sign in to view its latest status.", action: "View your account" },
